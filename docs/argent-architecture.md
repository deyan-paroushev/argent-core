> **Canonical location:** [`docs/reference/argent-architecture.md`](reference/argent-architecture.md). This copy is kept at the original path so previously shared links stay live. The content is identical.
...
**Canonical product direction:** `docs/reference/reserve-obligation-infrastructure.md`  
**Target domain profile:** `docs/reference/obligation-facility-profile.md`  
**Capacity orchestration:** `docs/reference/capacity-reservation-and-deliverability.md`  
**Institutional privacy:** `docs/reference/selective-disclosure-and-institutional-privacy.md`  
**Confidential production architecture:** `docs/reference/confidential-control-and-public-integrity.md`  
...
The bank owns the product and exposure decision. Argent records the bank-approved decision, reserves the corresponding capacity atomically, and refuses incompatible concurrent allocation. The canonical specification is [`capacity-reservation-and-deliverability.md`](reference/capacity-reservation-and-deliverability.md).
...
Candidate target reserve profiles are `ALLOCATED_BAR_SET`, `POOLED_GOLD_INTEREST`, and `DIGITAL_GOLD_ENTITLEMENT`. Only the first is current. See [`shared-gold-infrastructure-and-argent.md`](reference/shared-gold-infrastructure-and-argent.md).
...
See `docs/reference/threat-model-and-security-boundaries.md` for the detailed adversary and trust analysis.
